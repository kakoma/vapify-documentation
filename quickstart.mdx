...
After going live, call records will be retrieved from Vapi for that subaccount, and the pricing you set will be applied. Depending on the volume of records, this may take a few hours.
