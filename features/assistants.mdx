...
<AccordionGroup>
  <Accordion title="How do I create an assistant?">
    All assistants are created and edited directly in vapi.ai. All you then need to do is add your existing assistants to Vapify is add your Vapi.ai private key to a sub account, save your settings and the existing assistants will be retrieved.
  </Accordion>
</AccordionGroup>